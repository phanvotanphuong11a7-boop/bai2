...
gpio_state_t HAL_GPIO_ReadPin(gpio_port_t port, gpio_pin_t pin) {
    _Bool bit_status = 0;
    switch (port) {
        case PORT_A: bit_status = (PORTA & (1 << pin)) ? 1 : 0; break;
        case PORT_B: bit_status = (PORTB & (1 << pin)) ? 1 : 0; break;
        case PORT_C: bit_status = (PORTC & (1 << pin)) ? 1 : 0; break;
        case PORT_D: bit_status = (PORTD & (1 << pin)) ? 1 : 0; break;
        case PORT_E: bit_status = (PORTE & (1 << pin)) ? 1 : 0; break;
