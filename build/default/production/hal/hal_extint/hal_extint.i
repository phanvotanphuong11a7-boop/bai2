...
# 2 "<built-in>" 2
# 1 "hal/hal_extint/hal_extint.c" 2

# 1 "hal/hal_extint/hal_extint.h" 1




void HAL_ExtInt_RB0_Init(void);
# 3 "hal/hal_extint/hal_extint.c" 2
...
# 4 "hal/hal_extint/hal_extint.c" 2
